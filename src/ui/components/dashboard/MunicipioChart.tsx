...
export const MunicipioChart: React.FC<Props> = ({ data, currencyFormatter, visibleMetrics = DEFAULT_VISIBLE_METRICS }) => {
  ...
  return (
    <Card className="border border-zinc-200 rounded-lg shadow-sm">
      <DashboardCardHeader icon={MapPin} title="Distribuição por Município" description="Faturado · Custo · Bruto · Líquido · Glosa" />
