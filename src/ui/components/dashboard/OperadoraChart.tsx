...
export const OperadoraChart: React.FC<Props> = ({ data, currencyFormatter, visibleMetrics = DEFAULT_VISIBLE_METRICS }) => {
  ...
  return (
    <Card className="border border-zinc-200 rounded-lg shadow-sm">
      <DashboardCardHeader icon={Building2} title="Performance por Operadora" description="Faturado · Custo · Bruto · Líquido · Glosa" />
